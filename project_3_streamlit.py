{
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/vaidegiarch/project---3-/blob/main/project_3_streamlit.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "Di5l27bHz1L3",
        "outputId": "ee883e6e-98a8-4613-af5a-da97a0a721e6"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "source": [
        ...
        "file_path = '/content/drive/MyDrive/1random_forest.pkl'\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Oss-DDOybiP_",
        "outputId": "e7fb1ddf-a03a-4ebb-c8d8-8c46965008ff"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "0fOS7cHybrZn",
        "outputId": "6dcbf19f-6282-487d-c344-7e7f2d69f850"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wi54wUN7b_JY",
        "outputId": "f6dd6646-59e3-42a2-cea1-3c484c60f131"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "QELLH4XBdM3n",
        "outputId": "23e6888f-8fe9-458c-c41e-06cbf4334e9b"
      },
      "outputs": [
        {
          "name": "stdout",
          ...
          "text": [
            ...
            "Requirement already satisfied: rpds-py>=0.25.0 in /usr/local/lib/python3.12/dist-packages (from jsonschema>=3.0->altair!=5.4.0,!=5.4.1,<7,>=4.0->streamlit) (0.30.0)\n",
            "Requirement already satisfied: six>=1.5 in /usr/local/lib/python3.12/dist-packages (from python-dateutil>=2.8.2->pandas<3,>=1.4.0->streamlit) (1.17.0)\n",
            "Downloading pyngrok-7.5.1-py3-none-any.whl (24 kB)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "SMMFlBKUb6YC",
        "outputId": "4a1b60b1-daa0-46a3-fccd-df4ee068c341"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "G0Kkp8TLFcdb",
        "outputId": "c240d5ef-110b-4bcd-861d-a1b61330e4a4"
      },
      "execution_count": 9,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "--2026-03-26 07:40:00--  https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64\n",
            ...
            "--2026-03-26 07:40:00--  https://github.com/cloudflare/cloudflared/releases/download/2026.3.0/cloudflared-linux-amd64\n",
            "Reusing existing connection to github.com:443.\n",
            "HTTP request sent, awaiting response... 302 Found\n",
            "Location: https://release-assets.githubusercontent.com/github-production-release-asset/106867604/731ab2f8-6b77-4adb-a7b3-1104525e9d72?sp=r&sv=2018-11-09&sr=b&spr=https&se=2026-03-26T08%3A21%3A30Z&rscd=attachment%3B+filename%3Dcloudflared-linux-amd64&rsct=application%2Foctet-stream&skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&sktid=398a6654-997b-47e9-b12b-9515b896b4de&skt=2026-03-26T07%3A20%3A55Z&ske=2026-03-26T08%3A21%3A30Z&sks=b&skv=2018-11-09&sig=xQaW0DuT9jjwbBg%2FoX5Z8lfq8ihxjLHBO0ItG64GNF0%3D&jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc3NDUxMjYwMCwibmJmIjoxNzc0NTEwODAwLCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.GIXC0OzaV4y5lh9Qj9PENWFD4aq48wVighiIZ22rIVU&response-content-disposition=attachment%3B%20filename%3Dcloudflared-linux-amd64&response-content-type=application%2Foctet-stream [following]\n",
            "--2026-03-26 07:40:00--  https://release-assets.githubusercontent.com/github-production-release-asset/106867604/731ab2f8-6b77-4adb-a7b3-1104525e9d72?sp=r&sv=2018-11-09&sr=b&spr=https&se=2026-03-26T08%3A21%3A30Z&rscd=attachment%3B+filename%3Dcloudflared-linux-amd64&rsct=application%2Foctet-stream&skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&sktid=398a6654-997b-47e9-b12b-9515b896b4de&skt=2026-03-26T07%3A20%3A55Z&ske=2026-03-26T08%3A21%3A30Z&sks=b&skv=2018-11-09&sig=xQaW0DuT9jjwbBg%2FoX5Z8lfq8ihxjLHBO0ItG64GNF0%3D&jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc3NDUxMjYwMCwibmJmIjoxNzc0NTEwODAwLCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.GIXC0OzaV4y5lh9Qj9PENWFD4aq48wVighiIZ22rIVU&response-content-disposition=attachment%3B%20filename%3Dcloudflared-linux-amd64&response-content-type=application%2Foctet-stream\n",
            ...
            "\n",
            "cloudflared-linux-a 100%[===================>]  37.83M  --.-KB/s    in 0.1s    \n",
            "\n",
            "2026-03-26 07:40:00 (258 MB/s) - ‘cloudflared-linux-amd64’ saved [39667364/39667364]\n",
            "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "t-gJLSlaFlP-",
        "outputId": "90dbc81f-478a-414b-dcd8-8ac042595595"
      },
      "execution_count": 11,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Your tunnel url https://loads-intake-rough-danny.trycloudflare.com\n"
          ]
        }
      ]
    }
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNWAVmNWedVkpfkj9zNVuyd",
